...
{
    public class AutoOrdersController : BaseController
    {
        [Route("AutoOrders")]
        ...
        public ActionResult AutoOrderList()
        {
            ...
            viewModel.AutoOrders = ExigoDAL.GetCustomerAutoOrders(Identity.Current.CustomerID, includePaymentMethods: false);
        ...
        public ActionResult ManageAutoOrder(int id, ManageAutoOrderViewModel viewModel)
        {
            ...
            var isExistingAutoOrder = id != 0;
            var paymentMethods = ExigoDAL.GetCustomerPaymentMethods(new GetCustomerPaymentMethodsRequest() { CustomerID = Identity.Current.CustomerID, ExcludeIncompleteMethods = true });
